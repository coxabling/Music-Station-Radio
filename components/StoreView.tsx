...
import type { Theme, ThemeName, AvatarFrame } from '../types';
import { THEMES, AVATAR_FRAMES, StarIcon, LockIcon, CheckCircleIcon } from '../constants';
...
export const StoreView: React.FC<StoreViewProps> = ({ activeTheme, onSetTheme, unlockedThemes, onUnlockTheme, activeFrame, unlockedFrames, onSetFrame, onUnlockFrame, currentPoints }) => {
  const [activeTab, setActiveTab] = useState<'themes' | 'frames'>('themes');
    ...
    <div className="p-4 md:p-8 animate-fade-in h-full overflow-y-auto">
        <div className="max-w-6xl mx-auto">
            <header className="text-center mb-8 relative">
                ...
                <div className="inline-flex bg-gray-800 rounded-full p-1 border border-gray-700 relative z-10">
