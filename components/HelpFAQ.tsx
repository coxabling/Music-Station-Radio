    ...
    <div className="p-4 md:p-8 animate-fade-in h-full overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12">
          ...
          <p className="text-gray-400">Frequently Asked Questions & User Guide for Music Station Radio</p>
        </header>
        ...
        <div className="p-8 bg-gradient-to-br from-indigo-900/20 to-purple-900/20 rounded-2xl border border-white/10 text-center">
          ...
          <p className="text-gray-400 mb-6 max-w-lg mx-auto">Our support team is always ready to help you with any issues or inquiries regarding our global audio network.</p>
          <button 
